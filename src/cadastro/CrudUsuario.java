...
public class CrudUsuario {
	...
	private static final String URL = "jdbc:h2:file:C:/Users/damiao/eclipse-workspace/DesBack/bd/meubanco";
	private static final String USER = "sa";
	private static final String PASS = "";

	public static void main(String[] args) {
		try (Connection conn = DriverManager.getConnection(URL, USER, PASS); Scanner scanner = new Scanner(System.in)) {
